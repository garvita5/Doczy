...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between text-md py-4 border-b border-b-gray-400 mb-4">
      <img
        onClick={() => navigate("/")}
      ...
      <div className="flex items-center gap-4">
        {token && userData ? (
          ...
          <button
            ...
            className="bg-primary text-white px-8 py-3 rounded-full font-light hidden md:block cursor-pointer active:scale-95 transition-transform duration-150"
          >
            Create Account
          </button>
        )}
          ...
          <ul className="flex flex-col items-center gap-2 font-medium mt-5 px-5 text-lg">
            ...
            {!token && (
              <button
                ...
                className="bg-background text-primary px-6 py-3 rounded font-medium mt-4"
              >
                Create Account
              </button>
            )}
